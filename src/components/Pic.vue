...
<template>
  <div>
    ...
    <img v-if="imagePreviewUrl" :src="imagePreviewUrl" style="max-width: 400px; max-height: 400px;">
    <button @click="detect">上传并检测</button>
    <img v-if="detectionImageUrl" :src="detectionImageUrl" style="max-width: 400px; max-height: 400px;">
